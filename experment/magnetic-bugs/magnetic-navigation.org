...
Constant bias cancels in the CPU4 circuit, but /spatially varying/ bias
(from magnetic anomalies) would break this symmetry — the bug encounters
different perturbations during outbound and return legs. Direction A showed
anomalies are too weak to matter for the memoryless heading-follower, but
the question of whether they degrade PI more than heading remains open.
